...
def train_func(config: Dict):
    ...
    # Create model - Initialize RNNMLPClassifier
...
if __name__ == "__main__":
    ...
    parser.add_argument("--Sequence_length", type=int, default=64, help="Sequence length to input to the model.")
